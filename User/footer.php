              ...
              <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                  <div class="aa-footer-widget">
                    <div class="aa-footer-widget">
                      ...
                      <ul class="aa-footer-nav">
                        <li><a href="#">Công Tú</a></li>
                        <li><a href="#">Hoàng Nam</a></li>
                        <li><a href="#">Quang Huy</a></li>
                        <li><a href="#">Văn Khoa</a></li>
                        <li><a href="#">Hồng Hương</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 col-sm-6">
                  <div class="aa-footer-widget">
                    ...
                    <h3>Liên hệ </h3>
                      <ul class="aa-footer-nav">
                        <li><a href="#">Đại học thủy lợi</a></li>
                        <li><a href="#">Khoa Công  Nghệ Thông Tin</a></li>
                        <li><a href="#">Lớp 61TH6</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
