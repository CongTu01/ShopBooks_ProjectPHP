...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 10, 2021 lúc 10:48 AM
...
(5, 'admin', 'admin@gmail.com', '$2y$10$raQv4GRIAX8y47AVVUdZ..YwMWNQWDAMxwO1ySwfb2AlgpnX0wli6');
...
CREATE TABLE `giaohang` (
  ...
  `Email` text COLLATE utf8_unicode_ci NOT NULL,
  `SDT` int(11) NOT NULL,
  `Diacchi` text COLLATE utf8_unicode_ci NOT NULL,
  `Sum` int(11) NOT NULL,
  `ngay` date NOT NULL,
...
(17, 16, 'Tống Công Tú', 'tongcongtu01@gmail.com', 376907157, 'xuân phú _ nam định', 300000, '2021-11-10', 'Giao sớm cho em nhé'),
(18, 17, 'vô danh', '1951060703@e.tlu.edu.vn', 376907157, 'nam định', 850000, '2021-11-10', 'giao sớm nhé');
...
(18, 'Người ẩn anh', '1951060703@e.tlu.edu.vn', '$2y$10$/NTDjTFEJwFcJrd/kNir3.L/oLfyvg9msj3z8XzH9QOXiZ04Kd5by', 52381248),
...
--
ALTER TABLE `admin`
  MODIFY `IdAd` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `books`
--
ALTER TABLE `books`
  MODIFY `IdBook` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `giaohang`
  MODIFY `IdGiao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
