...
<html lang="en">
<style>
  .aa-head-top-nav-right li :hover{background:palevioletred}
                ...
                <ul class="aa-head-top-nav-right">
                  ...
                  <li>
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                      ...
                      <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $users[0]['NameUser'] ?></span>
                    </a>
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="./indexuser.php?id=<?php echo $users[0]['IdUser']?>">
                  ...
                  <p>Book<strong>Shop</strong> <span>Knowledge is power
                    </span></p>
                </a>
              ...
              <div class="aa-search-box">
                <form action="./product.php" method="GET">
                  <input type="text" name="timkiem" id="timkiem" placeholder="Tìm kiếm tên sách,tên tác giả,thể loại">
